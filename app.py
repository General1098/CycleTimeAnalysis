...
def timepiece_section(opts):
    ...
    aggregation_type=c3.selectbox("aggregationType",["average","sum","median","standardDeviation"],index=0)
    ...
    params={"page":1,"pageSize":int(page_size),"columnsBy":columns_by,"aggregationType":aggregation_type,"columns":columns}
